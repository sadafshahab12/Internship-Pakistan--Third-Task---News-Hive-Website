...
const Trending = () => {
  ...
  useEffect(() => {
    const TrendingNewsAPI = import.meta.env.VITE_NEWS_API_KEY;
  ...
  return (
    <section className=" bg-slate-700  py-8 px-6 text-slate-700 space-y-6 xxs:h-auto min-h-[40rem] ">
      ...
      <div className="xs:grid hidden grid-cols-1 sm:grid-cols-2 md:grid-cols-3 font-Karla gap-8 max-w-6xl mx-auto">
        {trendingNews.slice(0, 6).map((trendingNews, index) => {
          const date = new Date(trendingNews.publishedAt);
          ...
          return (
            ...
            >
              ...
              <a href={trendingNews.url} target="_blank">
